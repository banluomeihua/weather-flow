...
var ftpConfig = require("../private/server-config.json");
...
exports.download = function(resource, output) {
    ...
    var processDownload = function(res) {
        ...
        if (output) {
            res.pipe(output, { end: true });
        }
    };
    var req = (typeof options === "string" && options.startsWith("https:"))
        || (typeof options === "object" && options.protocol === 'https:')
            ? https.get(options, processDownload)
            : http.get(options, processDownload);
